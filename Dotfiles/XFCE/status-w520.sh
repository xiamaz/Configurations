...
NV=${$(< /proc/acpi/bbswitch)[(w)2]}

printf "<txt><span font_weight='bold'><span fgcolor='#D0B03C' font='FontAwesome' font_weight='normal'> </span> <span fgcolor='#FFE377'>%4.1f%% </span><span fgcolor='#72B3CC' font='FontAwesome' font_weight='normal'>   </span> <span fgcolor='#9CD9F0'>${avail} free</span> <span fgcolor='#C75646' font='FontAwesome' font_weight='normal'>  </span> <span fgcolor='#E09690'>${temp%.*}°C</span><span fgcolor='#8EB33B' font='FontAwesome' font_weight='normal'>    </span><span fgcolor='#cdee69'>${NV:l}</span></span></txt><tool> $m1 $m5 $m15</tool>" "$cpu"
