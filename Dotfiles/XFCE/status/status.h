...
/* enable optimus bbswitch status */
#define OPTIMUS 1
...
#if OPTIMUS == 1
static const char FORMAT_STRING[] = "<txt><span font_weight='bold'><span fgcolor='#D0B03C' font='FontAwesome' font_weight='normal'> </span> <span fgcolor='#FFE377'>%5.2Lf%% </span><span fgcolor='#72B3CC' font='FontAwesome' font_weight='normal'>   </span> <span fgcolor='#9CD9F0'>%d%c free</span> <span fgcolor='#C75646' font='FontAwesome' font_weight='normal'>  </span> <span fgcolor='#E09690'>%u°C</span><span fgcolor='#8EB33B' font='FontAwesome' font_weight='normal'>    </span><span fgcolor='#cdee69'>%s</span></span></txt><tool> %.2f %.2f %.2f</tool>";
#else
static const char FORMAT_STRING[] = "<txt><span font_weight='bold'><span fgcolor='#D0B03C' font='FontAwesome' font_weight='normal'> </span> <span fgcolor='#FFE377'>%5.2Lf%% </span><span fgcolor='#72B3CC' font='FontAwesome' font_weight='normal'>   </span> <span fgcolor='#9CD9F0'>%d%c free</span> <span fgcolor='#C75646' font='FontAwesome' font_weight='normal'>  </span> <span fgcolor='#E09690'>%u°C</span></span></txt><tool> %.2f %.2f %.2f</tool>";
#endif
#endif
